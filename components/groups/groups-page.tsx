...
const groupsData: Record<string, Group[]> = {
  afrique: [
    ...
    },
    {
      id: "sud",
      name: "Sud",
      description: "Pays d'Afrique Australe",
      countriesCount: 1,
    },
  ],
  asie: [
  ...
  amerique: [
    ...
    },
    {
      id: "sud",
      name: "Sud",
      description: "Pays d'Amérique du Sud",
      countriesCount: 2,
    },
  ],
  oceanie: [
    ...
    <div className="min-h-screen bg-background pb-24">
      ...
      <header className="sticky top-0 z-10 bg-background border-b border-border">
        <div className="flex items-center gap-4 px-4 py-4">
          ...
          <h1 className="text-xl font-semibold text-foreground">Groupes</h1>
        </div>
      </header>
              ...
              <div className="flex items-start justify-between gap-4">
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-sm text-muted-foreground">
                    ...
                    {group.countriesCount === 1 ? "pays" : "pays"}
                  </p>
                </div>
      ...
      >
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Êtes-vous sûr de vouloir supprimer le groupe {deletingGroup?.name}{" "}
              ? Cette action est irréversible. Les pays de ce groupe ne seront
              pas supprimés mais n'auront plus de groupe assigné.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
